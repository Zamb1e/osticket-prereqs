...
<p>
Create a "Virtual Machine(VM)" with Azure to run this lab. Use "Remote Desktop" to log into the created VM, using the VM's public IP. 
</p>
<br />
...
<p>
Download the <a href="https://drive.usercontent.google.com/download?id=1b3RBkXTLNGXbibeMuAynkfzdBC1NnqaD&export=download&authuser=0">OsTicket</a> installation files. Next, copy the "upload folder" from inside the OsTicket installation files to "c:\inetpub\wwwroot". Within c:\inetput\wwwroot folder --> rename "upload folder" to "OsTicket" --> Open IIS--> osTicket--> Browse*80 --> restart IIS
</p>
<br />
